...
const Pokemon2 = ({pokeData2}) => {
    ...
    let pkmnName = capitalizeFirstLetter(pokeData2.name)
            ...
            <div className="wholePage">
                ...
                <div className="otherHalfPage">
                    <div className="sprites">
                        <div>
                            <img src={pokeData2.sprites.front_default} alt={pokeData2.name} />
                            <h4>Non-Shiny</h4>
                        </div>
                        <div>
                            <img src={pokeData2.sprites.front_shiny} alt={pokeData2.name} />
                            <h4>Shiny</h4>
                        </div>
                    </div>
                    <div>
